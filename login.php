  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action = "configuraciones/operaciones_residente/agregar_res.php" method = "POST" class="row g-3 needs-validation was-validated" novalidate="">
          <div class="col-md-4">
          ...
          <div class="modal-footer">
              ...
              <button class="btn btn-primary" name = "btn-resi-agr" type="submit" data-bs-toggle="modal">Guardar</button>
              <!-- -->
