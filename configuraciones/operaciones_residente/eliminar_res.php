...
$upd_tit_pago = "UPDATE pago SET ID_TITULAR = NULL WHERE ID_TITULAR = $id";
$upd_inac_pago = "UPDATE pago SET INACTIVO = 1 WHERE ID_TITULAR = $id";
...
$update_inac = $conexion -> query($upd_inac_pago);
