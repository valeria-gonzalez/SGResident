...
<body>
                ...
                <div class="modal-body">
                    <form action="../configuraciones/operaciones_pago/agregar_pago.php" method="POST" class="row g-3 needs-validation was-validated">
                        ...
                        <div class="modal-footer">
                            ...
                            <button name=" btn-agr-pago" class="btn btn-primary" type="submit" onclick="location.href='recibo.php'" target="_blank">Guardar</button>
    ...
    <!-- Modal -->
    <div class="modal fade" id="generar_ticket" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="generar_ticket">¿Desea guardar el ticket?</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
